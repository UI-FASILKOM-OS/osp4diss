...
* The TOKEN of Week03 is OS202 (capital).
...
* check the disk usage with "du -s .".

* do "make"

* check the disk usage again with "du -s .".
...
cbkadal@osp:~/W03/tlpi-dist$ du -s .
2648	.
...
gpg: Signature made Mon 05 Oct 2020 08:11:05 PM WIB
